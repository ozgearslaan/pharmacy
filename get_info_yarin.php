...
$sql = pg_query($db,"SELECT eczaneadi,eczaneiladi,eczaneilceadi, eczaneadres, baslangic, bitis, glnno, id , public.ST_AsGeoJSON(public.ST_Transform((geog),4326),6) AS geojson FROM yarin_eczane;");
